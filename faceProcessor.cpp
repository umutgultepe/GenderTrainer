...
void initializeFaceProcessor()
{
  ...
  char *faceCascadeFilename = "/home/umut/Documents/libraries/OpenCV/data/haarcascades/haarcascade_frontalface_alt.xml";
    char *eyeCascadeFilename = "/home/umut/Documents/libraries/OpenCV/data/haarcascades/haarcascade_mcs_eyepair_small.xml";
    char *mouthCascadeFilename = "/home/umut/Documents/libraries/OpenCV/data/haarcascades/haarcascade_mcs_mouth.xml";
...
int processFace(IplImage* inputImage, IplImage* &faceImage, IplImage* &mouthImage, IplImage* &noseImage, IplImage* &eyeImage, bool cropped)
{
  ...
  //    cout<< "finding eyes!\n";
   ...
   //    cout<< "finding mouth!\n";
      ...
      if (mouthRect.y<eyeRect.y+eyeRect.height || mouthRect.y<245)
      {
	cvReleaseImage(&eyeImage);
	cvReleaseImage(&GaborImage);
...
//       {
//  	cout << "Nose Left,Right,Top,Bottom:" << mouthRect.y<<" "<<eyeRect.y+eyeRect.height<<" "<<noseRectTop<<" "<<noseRectBottom <<"\n";
// 	      cvNamedWindow("temp");
